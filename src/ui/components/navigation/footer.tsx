...
export const Footer = () => {
	...
	const footerNavigationList = footerLinks.map((colomLinks) => (
		<FooterLink key={uuidv4()} data={colomLinks} />
	));
			...
			<Container className="pt-9 pb-11 space-y-11">
				...
				<div className="flex items-center justify-between">
					<Typography variant="caption4" theme="gray">
						{`Copyright © ${currentYear} | Propulsed by Sofiane Lyafori - Code Collab SASU`}
					</Typography>
					<div className="">
